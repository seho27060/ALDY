      ...
      <section className="review-board">
        ...
        <div className="review-content">
          ...
          <div className="review-code">
            코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역 코드영역
          </div>
        ...
        <div className='review-btns'>
          ...
          {
            step === 3 ? <button className="reviewBtn" onClick={()=>{setRequestModalShow(true)}}>리뷰 요청하기</button> : 
            <button className="reviewBtn" onClick={()=>{
              // 제출하는 axios 요청 추가
            }}>코드 제출하기</button>
          }
        </div>
      ...
      <Modal.Body className='review-modal-body'>
        <div className='review-modal-header'>
          <div>
            ...
            <p style={{'fontSize':'12px', 'color':'#646464'}}>스터디원을 선택해주세요</p>
          </div>
          <div>
            <button className='review-modal-close-btn' onClick={props.onHide}>X</button>
          </div>
        </div>
        <div className='review-modal-content'>
          ...
          <button className='review-modal-request-btn' onClick={() => {
            props.onHide()
